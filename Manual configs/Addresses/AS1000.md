...
!
int f1/0
 desc TO R-1003-C (f0/0)
 ip add 130.0.102.5 255.255.255.252
 ipv6 add 2221:2566:1:1AC2::1/64
 ipv6 add FE80::1002:AC:1 link-local
 no sh
!
end
!
...
!
int f1/0
 desc TO R-1002-C (f0/1)
 ip add 130.0.102.9 255.255.255.252
 ipv6 add 2221:2566:1:1BC2::1/64
 ipv6 add FE80::1002:BC:1 link-local
 no sh
end
!
...
!
int l0
 ip add 130.0.102.252 255.255.255.255
 ipv6 add 2221:2566:1:102::C/128
 ipv6 add FE80::1002:C:1 link-local
 no sh
!
int f0/0
 desc TO R-1002-A (f1/0)
 ip add 130.0.102.6 255.255.255.252
 ipv6 add 2221:2566:1:1AC2::2/64
 ipv6 add FE80::1002:AC:2 link-local
 no sh
!
int f0/1
 desc TO R-1002-B (f1/0)
 ip add 130.0.102.10 255.255.255.252
 ipv6 add 2221:2566:1:1BC2::2/64
 ipv6 add FE80::1002:BC:2 link-local
 no sh
!
end
!
...
!
int f1/0
 desc TO R-1003-C (f0/1)
 ip add 130.0.103.5 255.255.255.252
 ipv6 add 2221:2566:1:1AC3::1/64
 ipv6 add FE80::1003:AC:1 link-local
 no sh
!
end
!
...
int f1/0
 desc TO R-1003-C (f0/1)
 ip add 130.0.103.9 255.255.255.252
 ipv6 add 2221:2566:1:1BC3::1/64
 ipv6 add FE80::1003:BC:1 link-local
 no sh
!
end
!
...
!
int l0
 ip add 130.0.103.252 255.255.255.255
 ipv6 add 2221:2566:1:103::C/128
 ipv6 add FE80::1003:C:1 link-local
 no sh
!
int f0/0
 desc TO R-1003-A (f1/0)
 ip add 130.0.103.6 255.255.255.252
 ipv6 add 2221:2566:1:1AC3::2/64
 ipv6 add FE80::1003:AC:2 link-local
 no sh
!
int f0/1
 desc TO R-1003-B (f1/0)
 ip add 130.0.103.10 255.255.255.252
 ipv6 add 2221:2566:1:1BC3::2/64
 ipv6 add FE80::1003:BC:2 link-local
 no sh
!
int f1/0
 desc TO R-1003-D (f0/0)
 ip add 130.0.113.1 255.255.255.252
 ipv6 add 2221:2566:1:1CD3::1/64
 ipv6 add FE80::1003:CD:1 link-local
 no sh
!
end
!
...
!
int l0
 ip add 130.0.113.255 255.255.255.255
 ipv6 add 2221:2566:1:113::D/128
 ipv6 add FE80::1003:D:1 link-local
 no sh
!
int f0/0
 desc TO R-1003-A (f1/0)
 ip add 130.0.113.2 255.255.255.252
 ipv6 add 2221:2566:1:1CD3::2/64
 ipv6 add FE80::1003:CD:2 link-local
 no sh
!
end
!
