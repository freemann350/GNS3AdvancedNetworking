...
!
int f0/1
 desc TO R-2001-B (f3/1)
 ip add 131.0.5.6 255.255.255.252
 ipv6 add 2221:2566:2:2150::2/64
 ipv6 add FE80::2001:3002:2 link-local
 no sh
!
int f1/0
 desc TO R-2002-C (f2/0)
...
!
int f1/1
 desc TO R-2002-C (f2/1)
 ip add 132.0.5.6 255.255.255.252
 ipv6 add 2221:2566:3:3150::2/64
 ipv6 add FE80::2002:3002:2 link-local
 no sh
!
end
